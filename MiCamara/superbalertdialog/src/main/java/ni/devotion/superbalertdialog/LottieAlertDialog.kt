...
class LottieAlertDialog private constructor(
    ...
    private var positiveBtnColor: Int?,
    private var positiveTextColor: Int?,
    private var negativeBtnColor: Int?,
    private var negativeTextColor: Int?,
    private var noneBtnColor: Int?,
    private var noneTextColor: Int?,
    customAsset: String?
) : AlertDialog(context)
{
    ...
    private var mPositiveListener : ClickListener? = positiveListener
    private var mNegativeListener : ClickListener? = negativeListener
    private var mNoneListener : ClickListener? = noneListener
